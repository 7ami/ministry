...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseuser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('citizenship_Number', models.BigIntegerField(unique=True, verbose_name='Citizenship Number')),
                ('contact_Number', models.BigIntegerField(verbose_name='Contact Number')),
                ('address', models.CharField(max_length=255)),
                ('enrolled_Organization', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='volunteers', to='accountsapp.OrganizationUser', to_field='organization_Name')),
            ],
            options={
